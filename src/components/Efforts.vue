    ...
    methods: {
      ...
      save() {
        if (this.editedIndex > -1) {
          axios
            .patch('http://localhost:9876/efforts/' + this.editedItem.position,
              {
                headers: {
          ...
          axios
            .post('http://localhost:9876/efforts/create',
              {
                headers: {
                  'Content-Type': 'application/json',
                }
      ...
      getAll() {
        axios
          .get('http://localhost:9876/efforts')
      ...
      remove(item) {
        ...
        axios
          .delete('http://localhost:9876/efforts/' + item.position)
          .then(response => {
            if (response.status === 200) {
              this.getAll();
            }
